...
export const MoreAboutMe = () => {
    return <SectionComponentBlack id="moreaboutme">
        <div className="max-w-6xl mx-auto py-10">
            <h2 className="font-caption text-4xl text-white py-4">À propos de moi</h2>
            <div className="flex max-md:flex-col items-start gap-6">
                <div className="flex-[5] w-full flex flex-col gap-4">
                    ...
                    <p className="text-white text-justify">Toujours désireuse de progresser, j’apprends vite et m’adapte facilement aux nouvelles technologies. Je souhaite également approfondir mes compétences en Back-end afin de mieux appréhender tout type de projet et d’élargir mon champ d’intervention.</p>
